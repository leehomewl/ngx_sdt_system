...
local influxdb_cron = require "ngx_spider.lua_script.influxdb_cron"
...
local find_cq_sql = function(cq_sql,cq_sql_online)
    ...
    --ngx.log(ngx.ERR,newstr_1)
    --ngx.log(ngx.ERR,newstr_2)
...
--              ngx.log(ngx.ERR,cq_name,cq_sql)
